...
<tr><th>성별</th>
	...
	<div class="form-check form-check-inline">
  		<label class="form-check-label">
  			<input class="form-check-input" <c:if test="${ vo.gender == '여' }"/> type="radio" name="gender" value="여">여
  		</label>
	</div></td>
</tr>
<tr><th>전화번호</th>
	<td><div class="row">
		<div class="col-auto">
			<input type="text" name="phone" value="${ vo.phone }" maxlength="13" placeholder="010-0000-0000" pattern="[0-9]{2,3}-[0-9]{3,4}-[0-9]{4}" class="form-control">
		</div>
	</div></td>
</tr>
<tr><th>이메일</th>

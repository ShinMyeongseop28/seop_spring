...
public class CommonUtility {
	...
	public String fileUpload(String category, MultipartFile file, HttpServletRequest request) {
		// d://smart/app/upload/profile/2024/8/27
		// d://smart/app/upload/notice/2024/8/27
		// d://smart/app/upload/board/2024/8/27
		String upload = uploadPath + category + new SimpleDateFormat("/yyyy/MM/dd/").format(new Date());
		// 해당 폴더의 존재유무를 확인해 없다면 폴더 만들기
		File dir = new File( upload );
		if( ! dir.exists() ) dir.mkdirs();
		
		// 업로드할 파일명을 고유한 id로 변경하기 : 7145ea2a-7895-4e93-a97d-b6f9d66c0c45.jpg
		...
		// d://smart/app/upload/profile/2024/8/27/7145ea2a-7895-4e93-a97d-b6f9d66c0c45.jpg
		// http://localhost:80/smart/upload/profile/2024/8/27/7145ea2a-7895-4e93-a97d-b6f9d66c0c45.jpg
		// http://localhost:80/smart
	...
	public String toUrlFilePath(String filepath, HttpServletRequest request) {
		return filepath.replace(uploadPath, appURL(request, "/upload/")); // "http://localhost:80/smart/upload/")
	}

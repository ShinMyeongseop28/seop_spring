				...
				<td>
					<div class="form-check form-check-inline">
						<label class="form-check-label"> 
							<input class="form-check-input" type="radio" name="gender" value="남" <c:if test='${vo.gender == "남" }'>checked</c:if> >남
						</label>
					</div>
					<div class="form-check form-check-inline">
						<label class="form-check-label"> 
				...
				<td>
					<div class="row">
						<div class="col-auto d-flex align-items-center">
							...
							<i role="button" class="fs-3 fa-solid fa-trash-can text-danger date-remove ${ empty vo.birth ? 'd-none' : ''}"></i>
						</div>
					</div>
				</td>
			</tr>
			...
			<tr>
				...
				<td><div class="row">
						<div class="col-auto d-flex gap-3">
							...
							<input type="text" name="post" value="${ vo.post }" class="w-px80 form-control" readonly="readonly">
						</div>
					</div>
					<div class="mt-3">
						<input type="text" name="address1" value="${ vo.address1 }" class="form-control mb-2" readonly="readonly">
...
<div class="btn-toolbar justify-content-center gap-2">
	...
	<button type="button" class="btn btn-outline-primary px-4" id="btn-cancel">취소</button>
</div>
</body>

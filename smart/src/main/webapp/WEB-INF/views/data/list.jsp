...
<ul class="nav nav-pills justify-content-center mb-3 data">
  <li class="nav-item"><a role="button" class="nav-link active">약국조회</a></li>
...
function showKakaoMap( tag ){
	...
	var markerPosition = new kakao.maps.LatLng(tag.data("y"), tag.data("x"))
	var container = document.getElementById('map'); //지도를 담을 영역의 DOM 레퍼런스
	var options = { //지도를 생성할 때 필요한 기본 옵션
		center: new kakao.maps.LatLng(tag.data("y"), tag.data("x")), //지도의 중심좌표.
	...
	var iwContent = `<div class="p-2 fw-bold text-primary">\${tag.text()}</div>`; // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
